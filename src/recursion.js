...
var sum = function(array) {
  ...
  return (n === undefined) ? 0 : (n + sum(arr));
};
...
var arraySum = function(array) {
  ...
  return (n === undefined) ? 0 : (n + arraySum(arr));
};
...
var reverse = function(string) {
  ...
  var [first, last] = [arr.shift(), arr.pop()];
  arr = last.concat( reverse( arr.join('').toString() ).concat( first ));
  return arr.toString();
};
...
var palindrome = function(string) {
  ...
  return (first === last) ? palindrome(str.substring(0, last + 1)) : false;
};
...
var reverseArr = function(array) {
  ...
  return reverseArr(array).concat([element]);
};
...
var fizzBuzz = function(n) {
  ...
  if (modulo(n, 3) === 0 && modulo(n, 5) === 0) {
    ele = 'FizzBuzz';
  } else if (modulo(n, 3) === 0 && modulo(n, 5) !== 0) {
    ele = 'Fizz';
  } else if (modulo(n, 3) !== 0 && modulo(n, 5) === 0) {
    ele = 'Buzz';
  }
...
var countOccurrence = function(array, value) {
  ...
  var countIncr = (array.pop() === value) ? 1 : 0;
  return countOccurrence(array, value) + countIncr;
};

// 21. Write a recursive version of map.
// rMap([1,2,3], timesTwo); // [2,4,6]
var rMap = function(array, callback) {
  var mutantArray = array.slice();
  if (mutantArray.length === 0) {
    return [];
  }
  var ele = mutantArray.pop();
  ele = callback(ele);
  return rMap(mutantArray, callback).concat([ele]);
};
...
var flatten = function(array) {
  ...
  arr.forEach( ele => {
    ele = Array.isArray(ele) ? flatten(ele) : ele;
    results = results.concat( ele );
  });
  return results;
};
